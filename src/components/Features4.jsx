...
export const Features4 = () => (
  <section
    className="w-full bg-gradient-to-t from-[#02032A] to-black"
    id="features"
  >
    <motion.div
      initial={{ opacity: 0 }}
    ...
    >
      <div className="flex flex-wrap items-center 2xl:w-[1450px] xl:w-[1300px] w-11/12 mx-auto md:pl-4 lg:py-[5rem] xl:pr-16 xl:pl-16">
        ...
        <div className="w-3/4 mx-auto lg:w-1/2 flex flex-wrap lg:-mx-4 justify-center">
          <div className="">
            <div className="">
              <img src={automated} alt="f1" className="mx-auto sm:mx-unset" />
            </div>
